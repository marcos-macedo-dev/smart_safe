...
const sections = [
  ...
  },
  {
    ...
    list: [
      'Login: Tela inicial onde autoridades e agentes fazem login com email e senha',
  ...
  },
  {
    ...
    list: [
      'Dashboard: Visão geral dos indicadores e estatísticas (Unidade e Agente)',
      'Mapa: Visualização geográfica das delegacias (Unidade e Agente)',
      'SOS: Listagem e detalhamento dos chamados de emergência (Unidade e Agente)',
      'Usuários: Gerenciamento de autoridades e agentes (apenas Unidade)',
      'Relatórios: Estatísticas detalhadas e gráficos (apenas Unidade)',
      'Perfil: Configurações pessoais e de segurança (Unidade e Agente)',
    ],
    tips: [
  ...
  },
  {
    ...
    icon: Users,
    content: ['Gerenciamento completo das autoridades da delegacia:'],
    list: [
      'Listagem de todas as autoridades com filtros por status e cargo',
      'Busca textual para encontrar autoridades específicas',
      'Paginação de resultados para melhor navegação',
      'Adição de novas autoridades através de envio de convite por email',
      'Edição de informações pessoais das autoridades',
      'Ativação/desativação de autoridades',
      'Exclusão de autoridades com confirmação de segurança',
  ...
  },
  {
    ...
    title: 'Meu Perfil',
    icon: User,
    content: ['Gerenciamento de perfil pessoal com diferenças entre autoridades e agentes:'],
    list: [
      ...
      'Para agentes: Funcionalidade de alteração de senha integrada',
  ...
  },
  {
    ...
    list: [
      ...
      'Sistema de convites por email para novas autoridades',
      'Recuperação de senha via email com token seguro',
      'Diferentes níveis de acesso: Unidade e Agente',
